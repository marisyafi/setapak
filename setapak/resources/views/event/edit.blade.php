                ...
                <div class="col-md-12">
                    <form action="{{ route('event.update', $event->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group @if($errors->has('title')) has-error @endif">
                            ...
                            <input type="text" id="title-field" name="title" class="form-control" value="{{ is_null(old("title")) ? $event->title : old("title") }}"/>
                            @if($errors->has("title"))
                        ...
                        <div class="form-group @if($errors->has('picture')) has-error @endif">
                            ...
                            <input type="file" id="picture-field" name="picture" accept="image/x-png,image/gif,image/jpeg" class="form-control" value="{{ is_null(old("picture")) ? $event->picture : old("picture") }}"/>
